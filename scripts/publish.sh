...
verify() {
  ...
  grep 'Repository Audit' "output/${sourceFolder}/ably-forks.md"
  grep 'Repository Audit' "output/${sourceFolder}/ably-labs.md"
...
publish() {
  ...
  cp "output/${sourceFolder}/ably-forks.md" "${repo}"
  cp "output/${sourceFolder}/ably-labs.md" "${repo}"
  cd -
